...
class MainWindow extends JFrame {
    ...
    public MainWindow() {
        ...
        itmAbout.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(null, "Программа построения фракталов Мандельброта и Жюлия.\nАвтор: Тимуркаева Л.М., группа 381505.", "О программе", INFORMATION_MESSAGE);
            }
        });
        /* Добавление в Меню */
        mnBar.add(mnFile);
